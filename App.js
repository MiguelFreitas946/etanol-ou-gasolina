  ...
  return (
    <View style={styles.container}>
		<View style={styles.titulo}>
			  <Text style={styles.txtTitulo}>Qual é melhor para Abastecer?</Text>
		</View>
		Com a alta nos preços dos combustíveis, é importante saber se o maior rendimento da gasolina vai te fazer economizar ou não.
		<View style={styles.bloco}>	  
		<View style={styles.blocoImg}>
			<Image style={styles.Img} source={require('./assets/adesivo.jpg',)}/>
			Insira os valores da Gasolina e do Álcool respectivamente.
		</View>
